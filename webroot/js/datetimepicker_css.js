...
var imageFilesPath = "/full_calendar/img/";
...
function RenderCssCal(bNewCal)
{
	...
	if (Cal.ShowTime === true)
	{
		...
		if (TimeMode === 12)
		{
			...
			vCalTime += "</td><td>";
			vCalTime += "<select name=\"ampm\" onChange=\"javascript:Cal.SetAmPm(this.options[this.selectedIndex].value);\" style='margin-left:2px;font-size: 12px; width:55px'>\n";
